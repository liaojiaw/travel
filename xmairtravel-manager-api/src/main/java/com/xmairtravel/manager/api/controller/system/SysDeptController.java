...
public class SysDeptController extends BaseController
{
    ...
    public ResultBean excludeChild(@PathVariable(value = "deptId", required = false) Long deptId)
    {
    ...
    public ResultBean getInfo(@PathVariable Long deptId)
    {
        ...
        return ResultBean.success(deptService.selectDeptById(deptId));
    }
    ...
    {
        List<SysDept> depts = deptService.selectDeptList(dept);
        return ResultBean.success(deptService.buildDeptTreeSelect(depts));
    }
