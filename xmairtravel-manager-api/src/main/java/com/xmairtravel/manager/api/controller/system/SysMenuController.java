...
public class SysMenuController extends BaseController
{
    ...
    {
        return ResultBean.success(menuService.selectMenuById(menuId));
    }
    ...
    {
        List<SysMenu> menus = menuService.selectMenuList(menu, getUserId());
        return ResultBean.success(menuService.buildMenuTreeSelect(menus));
    }
    ...
    public ResultBean add(@Validated @RequestBody SysMenu menu)
    {
        ...
        {
            return ResultBean.error("新增菜单'" + menu.getMenuName() + "'失败，地址必须以http(s)://开头");
        }
    ...
    public ResultBean edit(@Validated @RequestBody SysMenu menu)
    {
        ...
        {
            return ResultBean.error("修改菜单'" + menu.getMenuName() + "'失败，地址必须以http(s)://开头");
        }
        else if (menu.getMenuId().equals(menu.getParentId()))
        {
            return ResultBean.error("修改菜单'" + menu.getMenuName() + "'失败，上级菜单不能选择自己");
        }
