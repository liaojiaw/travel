...
import com.xmairtravel.core.server.manager.entity.bo.SysUserRole;
...
public class SysRoleController extends BaseController
{
    ...
    public ResultBean getInfo(@PathVariable Long roleId)
    {
        ...
        return ResultBean.success(roleService.selectRoleById(roleId));
    }
    ...
    public ResultBean edit(@Validated @RequestBody SysRole role)
    {
        ...
        return ResultBean.error("修改角色'" + role.getRoleName() + "'失败，请联系管理员");
    }
    ...
    {
        return ResultBean.success(roleService.selectRoleAll());
    }
    ...
    public ResultBean cancelAuthUserAll(Long roleId, Long[] userIds)
    {
    ...
    public ResultBean selectAuthUserAll(Long roleId, Long[] userIds)
    {
        roleService.checkRoleDataScope(roleId);
