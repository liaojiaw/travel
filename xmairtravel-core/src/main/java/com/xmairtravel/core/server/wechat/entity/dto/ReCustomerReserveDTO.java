...
@Data
public class ReCustomerReserveDTO {

    public ReCustomerReserveDTO(ReReserveBO reReserveBO){
    ...
    public static List<ReCustomerReserveDTO> copyPorperties(List<ReReserveBO> reReserveBOS){
        return reReserveBOS.stream().map(reUserBO -> {
            return new ReCustomerReserveDTO(reUserBO);
