...
import com.xmairtravel.core.exception.user.CaptchaException;
import com.xmairtravel.core.exception.user.CaptchaExpireException;
...
//        validateCaptcha(username, code, uuid);
    ...
    public void recordLoginInfo(Long userId)
    {
        ...
        sysUser.setLoginIp(IpUtils.getIpAddr(ServletUtil.getRequest()));
